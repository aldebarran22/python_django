...
urlpatterns = [
    ...
    re_path(
        "^accounts/logout/$",
        LogoutView.as_view(
            template_name="registration/logout.html", next_page="/accounts/profile"
        ),
        name="logout",
    ),
    ...
    path(
        "pagina1/",
        login_required(TemplateView.as_view(template_name="aplicacion12/pagina1.html")),
        name="pagina1",
    ),
    path(
        "escuchar_cancion/",
        permission_required("model_user.escuchar_cancion")(
            TemplateView.as_view(template_name="aplicacion12/escuchar_cancion.html")
        ),
        name="escuchar_cancion",
    ),
    path(
        "bajar_cancion/",
        permission_required("model_user.bajar_cancion")(
            TemplateView.as_view(template_name="aplicacion12/bajar_cancion.html")
        ),
        name="bajar_cancion",
    ),
]
